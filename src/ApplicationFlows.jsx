...
{ id: 'BF202608150026', store: '星河路店', org: '华东事业部', reason: '物料破损补发', date: '2026-08-18', status: '审批中', items: 2, qty: 3, applicant: '王小安', created: '2026-08-15 14:20', auditor: '—', auditedAt: '—', voidedAt: '—', orderNo: '—', note: '会员活动立牌运输中破损', rejectReason: '', productLines: makeProductLines([['card', 2], ['stand', 1]]), productNames: '会员权益卡（新版） 会员活动立牌', productCodes: 'SP-202608-001 SP-202608-016' },
  ...
  { id: 'BF202608130011', store: '星河路店', org: '华东事业部', reason: '物料破损补发', date: '2026-08-16', status: '已通过', orderStatus: '审核', items: 3, qty: 4, applicant: '王小安', created: '2026-08-13 16:42', auditor: '李木子', auditedAt: '2026-08-14 09:08', voidedAt: '—', orderNo: 'DD1001010000221', note: '会员活动物料破损补发', rejectReason: '', productLines: makeProductLines([['card', 1], ['stand', 1], ['poster', 2]]), productNames: '会员权益卡（新版） 会员活动立牌 会员活动海报', productCodes: 'SP-202608-001 SP-202608-016 SP-202608-021' },
  { id: 'BF202608120008', store: '苏州园区店', org: '华东事业部', reason: '版本换新补发', date: '2026-08-15', status: '已通过', orderStatus: '制单', items: 2, qty: 3, applicant: '周雨', created: '2026-08-12 09:31', auditor: '李木子', auditedAt: '2026-08-12 14:22', voidedAt: '—', orderNo: 'DD1001010000216', note: '商品属性校验失败，已回退为制单状态', rejectReason: '', productLines: makeProductLines([['card', 1], ['poster', 2]]), productNames: '会员权益卡（新版） 会员活动海报', productCodes: 'SP-202608-001 SP-202608-021' },
        ...
        {filtered.map((item) => (
          <article className="af-application-card" key={item.id} onClick={() => onOpen(item)}>
            ...
            <div className="af-card-body">
              ...
              <p><span>关联门店订单</span><b className={item.orderNo === '—' ? '' : 'link'}>{item.orderNo === '—' ? '—' : item.orderNo + ' · ' + (item.orderStatus || '审核')}</b></p>
    ...
    <main className="af-mobile-shell af-mobile-detail af-order-detail" data-layout-version="door-order-v2">
      ...
      <div className="af-detail-scroll">
        ...
        <section className="af-detail-document">
          ...
          {item.orderNo !== '—' && <button type="button" className="af-detail-link-row"><span>关联门店订单</span><b>{item.orderNo} · {item.orderStatus || '审核'}</b><ChevronRight size={16} /></button>}
        </section>
...
function PcStoreOrderDetail({ application, onBack }) {
  ...
  return (
    <div className="paf-content paf-store-order-detail">
      ...
      <section className="paf-order-balance"><span>门店余额：<b>5,836.91</b></span><span>授信额度：<b>100,000.00</b></span><span>可用余额：<b>105,836.91</b></span><i>{application.orderStatus || '审核'}</i></section>
